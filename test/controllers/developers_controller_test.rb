...
class DevelopersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create developer" do
    assert_difference('Developer.count') do
      post developers_url, params: { developer: { expertise: @developer.expertise, firstname: @developer.firstname, lastname: @developer.lastname } }
    end
  ...
  test "should update developer" do
    patch developer_url(@developer), params: { developer: { expertise: @developer.expertise, firstname: @developer.firstname, lastname: @developer.lastname } }
